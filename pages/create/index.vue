    ...
    <div class="object-form-container">
        ...
        <form class="object-form" @submit.prevent="handleSubmit">
            ...
            <div>
                ...
                <input id="title" type="text" v-model="title" required placeholder="e.g. Portefeuille" />
            </div>
            ...
            <div>
                ...
                <input id="contact_info" type="text" v-model="contact_info" required placeholder="e.g. @instagram"/>
            </div>

            <label>Location</label>
            <select id="type" v-model="location_type" required>
...
<script setup lang="ts">
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const { error: uploadError } = await useFetch(`${config.public.apiBaseUrl}/objects`, {
                method: 'POST',
                body: formData,
                credentials: 'include'
            })
